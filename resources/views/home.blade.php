                                    ...
                                    <div class="row g-3 mb-0 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <button type="button" class="btn btn-soft-success"><i
                                                    class="ri-add-circle-line align-middle me-1"></i> <a href="{{route('courses.create')}}">Thêm khoá học</a></button>
                                        </div>
                                        <!--end col-->
                                        <div class="col-auto">
                                            <button type="button"
                    ...
                    <div class="card">
                        <div class="card-header border-0 align-items-center d-flex">
                            ...
                            <div>
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item mx-1" role="presentation">
                                      <button class="btn btn-soft-secondary btn-sm" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false" onclick="Statistic(3)">3 tháng</button>
                                    </li>
                                    <li class="nav-item mx-1" role="presentation">
                        ...
                        <div class="card-header p-0 border-0 bg-light-subtle">
                            <div class="row g-0 text-center" id="statistic">
                                ...
                                <div class="col-6 col-sm-2">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1"><span class="counter-value" data-target="367">{{$order_complete}}</span>
                                        </h5>
                        ...
                        <div class="card-body">
                            ...
                            <div
                                ...
                                <div class="col-sm-auto  mt-3 mt-sm-0">
                                    <a href="{{route('orders.list')}}">Xem tất cả</a>
                                </div>
                            </div>
