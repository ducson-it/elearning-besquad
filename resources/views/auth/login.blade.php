                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index" class="d-inline-block auth-logo">
                                    <img src="{{ URL::asset('assets/images/beesquad-logo.png') }}" alt=""
                                        height="120px">
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">Beesquad & tận tâm</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Đăng nhập vào Beesquad Dashboard.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('email') is-invalid @enderror"
                                                value="{{ old('email', 'admin@beesquad.com') }}" id="username"
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> Beesquad <i class="mdi mdi-heart text-danger"></i> by BeesquadTeam
                            </p>
                        </div>
                    </div>
                </div>
