                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', 'admin@beesquad.com') }}" id="username" name="email" placeholder="Enter username">
                                        @error('email')
