        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Lịch sử học</h4>
                </div><!-- end card header -->
                <div class="card-body">
                            ...
                            <table class="table align-middle table-nowrap" id="customerTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="customer_name">Bài học</th>
                                ...
                                <tbody class="list form-check-all">
                                    @foreach ($histories as $index=>$history)
                                        <tr>
                                            ...
                                            <td class="customer_name">{{ $history->user->name }}</td>
                                            <td class="customer_name">{{ $history->course->name }}</td>
                                            <td class="customer_name">{{ $history->lesson->name }}</td>
                                            <td class="status"><span
                                                class="badge badge-soft-success text-uppercase">{{ $history->status == 1 ? 'Đã hoàn thành' : 'Chưa hoàn thành' }}</span>
                                            </td>
                                            <td class="date">{{ $history->created_at }}</td>
