                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <div class="edit">
                                                <button class="btn btn-sm btn-success edit-item-btn"> <a href="<?php echo e(route('blog.edit',1)); ?>">Edit</a></button>
                                            </div>
                                            <div class="remove">
                                                <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal">Remove</button>
                                            </div>
                                            <div class="detail">
                                                <button class="btn btn-sm btn-success edit-item-btn"> <a href="<?php echo e(route('tag.taggable',1)); ?>">Detail</a></button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\Backend-Web07\resources\views/tags/list.blade.php ENDPATH**/ ?>