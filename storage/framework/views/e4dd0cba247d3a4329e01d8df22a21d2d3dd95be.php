                    ...
                    <div class="row gy-4 d-flex justify-content-center">
                        ...
                        <div class="mx-6">
                            <div class="hstack gap-2 justify-content-end">
                                ...
                                <button type="button" class="btn btn-primary"><a style="color: white" href="<?php echo e(route('user.list')); ?>">Danh sách</a></button>
                            </div>
                        </div>
                        <!--end col-->
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\Backend-Web07\resources\views/users/create.blade.php ENDPATH**/ ?>