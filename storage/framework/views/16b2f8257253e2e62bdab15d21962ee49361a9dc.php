        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form action="<?php echo e(route('courses.topics.selected')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\Backend-Web07\resources\views/topics/course_select.blade.php ENDPATH**/ ?>