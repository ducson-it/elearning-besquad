                ...
                <div class="listjs-table" id="customerList">
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                <button type="button" class="btn btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> <a href="<?php echo e(route('user.create')); ?>"> Add</a></button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <div class="detail">
                                                <button class="btn btn-sm btn-success edit-item-btn"> <a href="<?php echo e(route('user.edit',1)); ?>">Edit</a></button>
                                            </div>
                                            <div class="remove">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\Backend-Web07\resources\views/users/list.blade.php ENDPATH**/ ?>